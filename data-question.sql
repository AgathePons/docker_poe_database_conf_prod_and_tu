...
insert into question (id, text, answer_type, order_in_survey, survey_id) values (6, 'Avez-vous trouve un emploi suite a votre formation ?', 'YES_NO', 0, 3);
...
insert into question (id, text, answer_type, order_in_survey, survey_id) values (8, 'Avez-vous une remarque à faire pour nous aider a vous accompagner dans l''apres formation ?', 'FREE', 2, 2);